...
we will create a play id by pasting together the
`first`, `last`, `occupation`, `city` and `state` variables.

```{r playerid}
d[["playerid"]] <- with(d,
  paste(first, last, occupation, city, state, sep="."))
```
